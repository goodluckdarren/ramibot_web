...
<head>
    ...
    <script>
        function displayFileName(input) {
            ...
            uploadTitle.textContent = fileName; // Display only the file name without "File: "
            uploadTitle.title = fileName; // Set the title attribute for full file name on hover
        }
