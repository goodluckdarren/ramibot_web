...
<head>
    ...
    <link rel="stylesheet" href="../calendars/calendars_image_layout.css">
        ...
        <div class="content">
            ...
            <div class="main-menu">
                <div class="main-panel">
                    <form action="calendars_upload.php" method="post" enctype="multipart/form-data" onsubmit="return showFileName()">
